pub fn encode(n: u64) -> String {
    match n {
        ...
        100..=999 => format!("{} hundred {}", encode(n / 100), encode(n % 1_00)),
        1_000..=999_999 => format!("{} thousand {}", encode(n / 1_000), encode(n % 1_000)),
        ...
        1_000_000_000_000_000_000..=18_446_744_073_709_551_615 => format!(
            "{} quintillion {}",
